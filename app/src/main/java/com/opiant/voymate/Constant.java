...
public class Constant {
    ...
    public static String APP_URL = "https://play.google.com/apps/testing/app.purseapp";
    private static String DESIGNED_BY = "Designed by Kishan Singh in India";
    public static String SHARE_CONTENT = "A beautiful app designed with Material Design:\n" + APP_URL + "\n- " + DESIGNED_BY;
    public static String EMAIL = "mailto:voymateapp@gmail.com";
